<template>
  <div class="meteor-page">
    <main class="meteor-main">
      <div class="container">
        <div class="page-header">
          ...
          <h1 class="page-header__title">流星信箱</h1>
          <p class="page-header__subtitle">许下心愿，等待流星划过</p>
        </div>
        ...
        <div class="meteor-container">
          <div class="wall">
            ...
            <div class="empty-wall" v-if="notes.length === 0">
              ...
              <p>流星信箱空空如也</p>
              <router-link to="/deposit" class="btn btn--outline btn--sm">写下心愿</router-link>
            </div>
          </div>
            ...
            <div class="stats-card">
              ...
              <div class="stats-grid">
                <div class="stat-item">
                  ...
                  <span class="stat-label">心愿总数</span>
                </div>
              </div>
            </div>
    ...
    <el-dialog v-model="showDetailDialog" title="心愿详情" width="500px">
      <div class="wish-detail" v-if="currentNote">
        ...
        <div class="detail-footer">
          ...
          <div class="detail-actions">
            ...
            <button class="mini-btn" @click="moveSingle('留声匣')">移到留声匣</button>
    ...
    <el-dialog v-model="showEditDialog" title="编辑心愿" width="450px">
      <div class="edit-form">
...
async function fetchNotes() {
  await noteStore.fetchNotes({ status: '流星信箱', limit: 100 })
...
async function deleteSelected() {
  if (selectedNotes.value.length === 0) return
  try {
    await ElMessageBox.confirm('确定要删除选中的心愿吗？', '提示', { type: 'warning' })
    for (const noteId of selectedNotes.value) {
...
async function deleteSingle() {
  if (!currentNote.value) return
  try {
    await ElMessageBox.confirm('确定要删除这个心愿吗？', '提示', { type: 'warning' })
...
.edit-btn {
  ...
  &:hover { background: rgba(212, 165, 116, 0.4); }
}
